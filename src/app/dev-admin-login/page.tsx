...
// developer who already knows the URL can sign in as an existing admin
// (by email) without a password, while testing the Admin Panel locally.
// Gated server-side here (not just by hiding the form client-side) with
// the exact same flag that decides whether lib/auth/index.ts registers the
// "dev-bypass" NextAuth provider at all — in production, this route 404s
// outright instead of rendering a dead form.
