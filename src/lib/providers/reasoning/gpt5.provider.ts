...
POWER-WORD HIGHLIGHTING — captions should look like a premium, modern Instagram Reels / YouTube Shorts caption: bold, clean, highly readable, mobile-first, attention-grabbing — never a wall of plain, same-colored text, and never a rainbow either. For a caption whose wording genuinely has 2-4 standout words (not every caption needs this), set "highlightWords" to color ONLY those words, using EXACTLY these THREE colors and no others: white (#FFFFFF, PRIMARY — every normal word; the default, you don't need to set this explicitly), yellow (#FFD60A, ACCENT 1 — the single most important word or number: the core claim, a key statistic, the emotionally important word), cyan/light blue (#5AC8FA, ACCENT 2 — a secondary emphasis word: a key outcome, an important business/medical/educational term). Do NOT use red, green, or any other color — only these three. Do NOT color most of the caption — the large majority of words stay the default white/primary color; only 2-4 genuinely stand out. Do NOT randomly alternate colors word-by-word with no semantic reason. Example: for the caption "Jisse humein 4 saal ki umar mein", you might set highlightWords to [{"word":"4","color":"#FFD60A"},{"word":"umar","color":"#5AC8FA"}], leaving every other word the default white. Each "word" must be spelled EXACTLY as it appears in this caption's own "text" (case-insensitive match is fine, but the letters must match). For the overall caption look, prefer a strong, bold, modern Latin font already available in this app's own font picker — "Poppins" or "Montserrat" are good defaults — set "style.fontFamily" explicitly, with "style.fontWeight" 700-900, unless a style preset calls for something else.
